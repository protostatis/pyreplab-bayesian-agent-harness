...
EXECUTION_GENERATION = "v15"
REQUEST_SCHEMA_VERSION = "m3-prompt-only-authorization-request-v15"
AUTHORIZATION_SCHEMA_VERSION = "m3-prompt-only-execution-authorization-v15"
CELL_RESULT_SCHEMA_VERSION = "m3-prompt-only-cell-result-v1"
COMPLETION_RECEIPT_SCHEMA_VERSION = "m3-prompt-only-completion-receipt-v15"
...
REMOTE_PREFLIGHT_SCHEMA_VERSION = "m3-prompt-only-remote-preflight-v15"
...
SUBSTRATE_EVIDENCE_SCHEMA_VERSION = "m3-prompt-only-substrate-evidence-v15"
