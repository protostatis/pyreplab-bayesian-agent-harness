...
class RunnerGateTest(unittest.TestCase):
    ...
    def test_infrastructure_record_retains_sanitized_stderr_tail(self) -> None:
        ...
        raw_stderr = (
            ...
            "--api-key pyreplab-prompt-pilot-dummy-key-v15\n"
...
class WallBudgetV9Test(unittest.TestCase):
    ...
    def test_v8_execution_artifacts_rejected(self) -> None:
        ...
        self.assertEqual(EXECUTION_GENERATION, "v15")
        self.assertEqual(REQUEST_SCHEMA_VERSION, "m3-prompt-only-authorization-request-v15")
        self.assertEqual(AUTHORIZATION_SCHEMA_VERSION, "m3-prompt-only-execution-authorization-v15")
        self.assertEqual(COMPLETION_RECEIPT_SCHEMA_VERSION, "m3-prompt-only-completion-receipt-v15")
        self.assertEqual(REMOTE_PREFLIGHT_SCHEMA_VERSION, "m3-prompt-only-remote-preflight-v15")
        self.assertEqual(SUBSTRATE_EVIDENCE_SCHEMA_VERSION, "m3-prompt-only-substrate-evidence-v15")
...
class OffServerBindingPolicyTest(unittest.TestCase):
    ...
    def test_slot_action_directory_path_derived_from_screen_id(self) -> None:
        ...
        self.assertEqual(
            SLOT_ACTION_DIRECTORY,
            "/tmp/m3-prompt-only-pilot-20260816-v15-erase-only-slot-actions",
        )
